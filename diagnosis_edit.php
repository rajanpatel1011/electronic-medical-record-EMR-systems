...
//  $emp_id=$_GET['emp_id'];
  ...
  $query3=mysql_query("UPDATE avail_diagnosis SET d_id='$d_id', d_name='$d_name', price='$price', remarks='$remarks' WHERE d_id='$d_id'")or die();
if($query3)
{
...
$query1=mysql_query("select * from avail_diagnosis where d_id='$d_id'");
...
<table border="0" width="100%" align="center" class="demo-table">
    ...
    <div class="msg"><?php if(isset($msg)) echo $msg; ?></div>
		...
		<td><input type="text" class="demoInputBox" readonly="readonly" name="d_id" value="<?php echo $query2['d_id']; ?>"></td>
		</tr>
        <tr><td>Diagnosis Name</td>
		<td><input type="text" class="demoInputBox" name="d_name" value="<?php echo $query2['d_name']; ?>"></td>
		</tr>
        <tr><td>Price</td>
